...
pkgs <- c('circlize','ComplexHeatmap','data.table','ggplot2','gtsummary','gt')
if(!require(ComplexHeatmap)) { BiocManager::install('ComplexHeatmap') } # Special install
...
data[
  ...
  add_overall() |> as_gt() |> gt:::as.tags.gt_tbl()
