...
* `00b_MESA_PICSURE_import_exams12345.ipynb` and `00b_download_table_setup.ipynb` are no longer relevant, and will not disappear from GitHub despite me having made a commit deleting them. A bug in GitHub? Regardless, these can be ignored.
