...
phs000007_search <- readRDS('search_results.rds') |> setDT() # (I don't know how many phs00007 varaibles there are because I don't have access, so just assume Kenny has an RDS of full search results.)
...
# Dealing with duplicate columns in FHS (phs000974)
...
fhs_full <- topmed_query[
  ...
  ][, .SD, .SDcols=!patterns('^unit_') # Don't need the "unit_..." cols
]
```
