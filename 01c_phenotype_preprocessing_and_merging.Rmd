...
mergecoalesce(by='mesa_id', all=T, force_coalesce=T,
  ...
  melt(
    ...
    measure.vars = list(
      ...
      c( 'ahei_2010_1',  'ahei_2010_1',  'ahei_2010_1',  'ahei_2010_1',  'ahei_2010_1' ), # < These variables were only measured in exam 1.
      c('dash_sodium1', 'dash_sodium1', 'dash_sodium1', 'dash_sodium1', 'dash_sodium1' ), # < We use the exam 1 value for all exams.
      c(      'alcwk1c',      'alcwk1c',      'alcwk1c',      'alcwk1c',      'alcwk1c'), # <
...
data <- data[
  # Winsorization and imputation
     ...
     # TODO some sort of imputation for exam 4 PA variables

  ][is.na(smoking) | smoking=='', smoking := 'NEVER'
  ][is.na(income)  |  income=='', income  := 'Missing'

  ][is.na(site)    |    site=='', site    := 'Unknown'
  ][is.na(month)   |   month=='', month   := 'Unknown'
  ][is.na(season)  |  season=='', season  := 'Unknown' # All the same samples are missing season/month/site. 117 samps '', 21 sams NA. Should these be kept as 'Unknown' or discoarded? Only 2 have genotype data so doesn't relaly matter.
