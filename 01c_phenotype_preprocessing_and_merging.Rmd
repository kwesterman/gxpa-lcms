...
data <- data[
  ...
  #][ exam==1 & is.na(            age),             age :=   age_median # No median imputation for age nor bmi
  ...
  # Carry-over-from-previous-exam imputation (this is why we setorder()'d by exam before
                ...
                'age', # Technically we have the information to impute this more accurately but I am too lazy and it's only for 117 samples
                'bmi','sex',
