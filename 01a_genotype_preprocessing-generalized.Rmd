...
# Get chr17 VCF's URL for bcftools. Download index file too.
...
fwrite(snps[,.(CHR,POS)], "regions.txt", col.names=F, sep='\t')
fwrite(snps[,.(  ID   )], "rsids.txt",   col.names=F          )
```
