...
{ mwas[      lm_p < .05, plot(      lm_est/      lm_se,       lmm_est/      lmm_se, col=rgb(0,0,0,0.2),pch=16,main='Metabolites whose LM p-value was < 0.1')] + abline(0,1,col='red') + abline(0,999) + abline(0,0) }
{ mwas[intrx_lm_p < .05, plot(intrx_lm_est/intrx_lm_se, intrx_lmm_est/intrx_lmm_se, col=rgb(0,0,0,0.2),pch=16,main='Metabolites whose **Interaction** LM p-value was < 0.1')] + abline(0,1,col='red') + abline(0,999) + abline(0,0) }
